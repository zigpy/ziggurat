...
#ifndef SL_RAIL_UTIL_INIT_EVENT_TX_CCA_ACTIVATED_INST0_ENABLE
#define SL_RAIL_UTIL_INIT_EVENT_TX_CCA_ACTIVATED_INST0_ENABLE 0
#endif
...
#define SL_RAIL_UTIL_INIT_EVENT_INST0_MASK (RAIL_EVENTS_NONE              \
  ...
  | (SL_RAIL_UTIL_INIT_EVENT_TX_CCA_ACTIVATED_INST0_ENABLE                \
    ? RAIL_EVENT_TX_CCA_ACTIVATED : RAIL_EVENTS_NONE)                                  \
